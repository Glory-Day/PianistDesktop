...
def main(resources):
    ...
    # main title
    st.markdown("<h1 style='text-align: center;'>Computer Vision<h1>", unsafe_allow_html=True)
    ...
    # content
    st.write("2분쉼표와 온음표는 각각 2번, 3번줄에만 위치한다. 2번, 3번줄에서 BFS 알고리즘을 이용해서"
             " 사각형 객체에 도달한다면 해당 사각형 객체는 2분, 온쉼표이다.")
